// We are going to build a small TypeScript program that describes a mini online shop. The goal is to represent a customer,
// their shopping cart, and calculate the total price.
...
//add more products for electronics
...
//add function display cart customer name and products
//add function filterByCategory -  recieve products and categorie as paramaeter
//add function calculateTotalPrice - recieve customer data and combine all product price
